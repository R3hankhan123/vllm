...
def _get_cpu_list() -> list[LogicalCPUInfo]:
    ...
    lscpu_output = subprocess.check_output(
        "lscpu -J -e=CPU,CORE,NODE,SOCKET,BOOK,DRAWER", shell=True, text=True
    )

    # For platform without NUMA/SOCKET/BOOK/DRAWER, replace '-' to '0'
    ...
    # (only id, physical_core, numa_node are required)
    logical_cpu_list = [
